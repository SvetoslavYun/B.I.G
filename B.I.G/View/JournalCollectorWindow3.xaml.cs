...

{
    public partial class JournalCollectorWindow3 : System.Windows.Window
    {
        ...
        public JournalCollectorWindow3(DateTime date, string area)
        {
        ...
        public void FillData()
        {
...

            {
                ...
                foreach (var item in journalCollectorController.GetAllCashCollectors3(Convert.ToDateTime(Date.Text), Are.Text))
                {
